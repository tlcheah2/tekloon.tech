        ...
        <div class="container container-nav">
            ...
            <nav>
                <ul class="navigation">
                    ...
                    <li><a href="./recent-posts" class="nav-link current-page">Recent posts</a></li>
                </ul>
            </nav>
        </div> <!-- / .container -->
    </header>
        ...
        <section class="article-container">
            <article class="normal-article">
                <div class="thumbnail-container">
                    <img src="/media/minimalism-blog/life.jpg" alt="life" class="article-thumbnail" />
                    <p class="date-comment">July 19, 2019 | 3 comments</p>
                </div>
                <div class="article-content-container">
                    <p class="section-title">Finding simplicity in life</p>
                    <p class="section-content article-subtitle"><strong>Life can get complicated really
                            quickly</strong>, but it doesn't have to be! There are many
                        ways to simplify your life, a few of which we've explored in the past. This week we're taking a
                        bit of a
            ...
            <article class="normal-article">
                ...
                <div class="article-content-container">
                    ...
                    <p class="section-content article-subtitle">Food is a very important part of everyone's life. If you
                        want to be healthy, you
                        have to eat healthy. One of the easiest ways to do that is to keep your cooking nice and simple.
                    </p>
                    <a href="#" class="link-continue-reading">continue reading</a>
                </div>
            </article>
            <article class="normal-article">
                ...
                <div class="article-content-container">
                    ...
                    <p class="section-content article-subtitle">Work is often a major source of stress. People get
                        frustrated, it ruins their
            ...
            <article class="normal-article">
                <div class="thumbnail-container">
                    <img src="/media/minimalism-blog/deco.jpg" alt="life" />
                    <p class="date-comment">July 3, 2019 | 3 comments</p>
                </div>
                <div class="article-content-container">
                    <p class="section-title">Simple decorations</p>
                    <p class="section-content article-subtitle">A home isn't a home until you've decorated a little.
                        People either don't decorate,
                        or they go overboard and it doesn't have the impact they were hoping for. Staying simple will
                        help draw the
